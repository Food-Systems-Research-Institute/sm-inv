# Make two latex tables for paper
...
giant_tab <- readRDS(here::here("0_prep", "output", "dp_meta.rds"))
get_str(giant_tab)
...
trend_files <- dir("4_trends/output/trend_plots")
...
writeLines(body_out, "4_trends/output/tab_metrics_body.tex")
...
# Save this to latex file
writeLines(app_body_out, "4_trends/output/tab_metrics_appendix.tex")
